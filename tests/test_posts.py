...
@pytest.mark.parametrize("title, content, published", [
    ("4th post", "4th content", True),
    ("fifth post", "fifth content", False),
    ("sixth post", "sixth content", True)
])
...
def test_delete_post_not_exists(authorized_client, test_user, test_posts):
